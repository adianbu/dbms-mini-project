DROP database if exists metro_database;

create database if not exists metro_database;

use metro_database;

create table CUSTOMER(Username varchar(20) primary key,Fname varchar(10),Lname varchar(10),Address varchar(20),Phone_No varchar(10),Password varchar(16),Email varchar(30));

insert into CUSTOMER values('SwarupE','Swaroop','E','Harohalli',9880012292,'swarup',"swarup.e1998@gmail.com");
...
insert into ADMIN values(1,'Tharun',19,'M','tharun@gmail.com','123456');
insert into ADMIN values(2,'Adithya',19,'M','adithya@gmail.com','123456');
